...
<embed src="/Yakuza 5 cutscene_Home run.mp4" loop="true" autostart="true" width="2" height="0">
	...
	<embed src="/Hope.mp3" loop="false" autostart="true" width="0" height="2">
