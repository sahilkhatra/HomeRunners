...
<body>
<embed src="/Yakuza 5 cutscene_Crowd cheering for Shinada 2.mp4" loop="false" autostart="true" width="2" height="0">
		<embed>
	<header>
	...
	<div class="row">
		...
		<div class="container">
			<h3 class="text-center">Top 2018 MLB Batter Stats by Batting Average</h3>
			<hr>
			<div>
			<img src="/Shinada and the Manager.jpg" height="174" width ="274">
			<img src="/Shinada prepares to play.jpg" height="174" width ="274">
			<img src="/Shinada prepares to strike.jpg" height="174" width ="274">
			<img src="/Shinada close up 2.jpg" height="174" width ="274">
